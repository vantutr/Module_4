...
@Component
public class CustomSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {   //điều hướng người dùng sau khi đăng nhập thành công.
    //  RedirectStrategy: interface để xử lý việc chuyển hướng
    //DefaultRedirectStrategy: là một implementation mặc định dùng để gửi redirect HTTP
